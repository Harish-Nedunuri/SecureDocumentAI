from ragcore.DocuPromptTask.args import DocuPromptArgs,MultiDocuPromptArgs
from ragcore.DocuPromptTask.entry_singledocchat import GetPromptResponse
from ragcore.DocuPromptTask.entry_multidocchat import MultiDocPromptResponse
