...
@router.post("/token", response_model=Token, description="Login to Acquire an Access Token and Refresh Token")
async def login_for_access_token(
    ...
    return {"access_token": access_token, "access_token_expires_mins": ACCESS_TOKEN_EXPIRE_MINUTES, "token_type": "bearer", "refresh_token": refresh_token, "refresh_token_expires_days": REFRESH_TOKEN_EXPIRE_DAYS}
...
@router_refresh.post("/refresh-token", description="Refresh an Access Token using a Refresh Token")
...
@router_success.get("/success-endpoint")
...
oauthapp.include_router(router)
oauthapp.include_router(router_refresh)
oauthapp.include_router(router_success)
